module.exports = {
    PARAM_ERROR: {
        ...
        'YEAR_LIMIT: $[1] $[2] $[3]': {
            'default': '$[1] should be 1985 TO CURRENT YEAR',
            'ar': 'يجب أن يكون $[1] 1985 حتى العام الحالي',
            'es': '$[1] debe ser de 1985 al año actual',
            'pt': '$[1] deve ser de 1985 até o ano atual'
        },
        'TEXT_LIMIT: $[1] $[2] $[3]': {
    ...
    ERROR: {
        ...
        'EXIST: $[1] $[2]': {
            'default': 'Your $[1] already exists in $[2]',
            'ar': 'لديك $[1] موجود بالفعل $[2]',
            'es': 'Tu $[1] ya existe $[2]',
            'pt': 'Seu $[1] já existe $[2]'
        },
        'OTP': {
         ...
         'MISSING_DOC': {
            'default':'Provider should upload all documents, all those document need be approved by you to approve vehicle',
            'ar': 'ييجب على المزود تحميل جميع المستندات ، ويجب أن تتم الموافقة على جميع هذه المستندات من قبلك للموافقة على السيارة ' ,                                                                                                                                                                                                                                                                                                                                                                      
            'es': 'El proveedor debe cargar todos los documentos, todos esos documentos deben ser aprobados por usted para aprobar el vehículo.',
            'pt': 'O provedor deve fazer upload de todos os documentos, todos esses documentos precisam ser aprovados por você para aprovar o veículo'
        },
        'PASSWORD': {
        ...
        'NO_ACTIVE_SERVICE': {
            'default': 'All services of your selected vehicle is inactive, update your Service Type',
            'ar': 'لم يتم العثور على خدمة نشطة.',
            'es': 'No se encontró ningún servicio activo.',
            'pt': 'Não foi encontrado nenhum serviço ativo.'
        },
        'NO_ACTIVE_SERVICE_CONTACT': {
            'default': 'All services of your selected vehicle is inactive, Please Contact Admin',
            'ar': 'لم يتم العثور على خدمة نشطة.',
            'es': 'No se encontró ningún servicio activo.',
            'pt': 'Não foi encontrado nenhum serviço ativo.'
        },
        ...
        'PROMOCODE_INVALIDAMOUNT: $[1]': {
            'default': 'Amount has to be atleast $[1]',
            'ar': 'يجب أن يكون المبلغ على الأقل $[1]',
            'es': 'La cantidad tiene que ser al menos $[1]',
            'pt': 'Quantidade deve ser pelo menos $[1]'
        },
        ...
        'CONTACT_ADMIN': {
            'default': 'You Account was not activated please contact Admin',
            'ar': 'لم يتم تنشيط حسابك يرجى الاتصال بالمسؤول',
            'es': 'Su cuenta no fue activada por favor contacte al administrador',
            'pt': 'Sua conta não foi ativada, entre em contato com o administrador'
        },
        'CONTACT_ADMIN_USER': {
            'default': 'You Account has been blocked please contact Admin',
            'ar': 'لم يتم تنشيط حسابك يرجى الاتصال بالمسؤول',
            'es': 'Su cuenta no fue activada por favor contacte al administrador',
            'pt': 'Sua conta não foi ativada, entre em contato com o administrador'
        }
